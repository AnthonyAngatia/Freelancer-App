...
public class ClientProjectViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String project_status_display = openClientProjectViewIntent.getStringExtra("project_status_display");
        clientProjectStatus = findViewById(R.id.client_project_status);
        if(project_status_display.equals("completed")){
        ...
        clientProgressText.setText(openClientProjectViewIntent.getStringExtra("project_progress"));
