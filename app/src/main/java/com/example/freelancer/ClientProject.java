...
public class ClientProject {
    ...
    public ClientProject(int projectId, String projectStatus, String projectReview, String projectDescription, double projectPrice, String projectDeliveryTime, String projectProgress, int appuser_inviter_id, int appuser_freelancer_id, String projectItemRequestorName, String projectItemRequestorLocation, String projectItemRequestorPhone) {
    ...
    public ClientProject( String projectItemRequestorName, String projectItemRequestorLocation, String projectItemRequestorPhone) {
        this.projectItemRequestorName = projectItemRequestorName;
        this.projectItemRequestorLocation = projectItemRequestorLocation;
        this.projectItemRequestorPhone = projectItemRequestorPhone;
    }
