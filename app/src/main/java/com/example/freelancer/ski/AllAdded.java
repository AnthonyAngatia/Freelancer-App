...
import static com.example.freelancer.classes.FreelanceServiceManager.loginPreference;
    ...
    public class AllAdded extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.ski_all);
            ...
            URL_DATA = "http://sheltered-plains-24359.herokuapp.com/api/userskills/" + userId;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DATA, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try{
                        ...
                        desAdapter = new AllAdapter(desList, getApplicationContext());
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(com.example.freelancer.ski.AllAdded.this, "Error"+error.toString(), Toast.LENGTH_SHORT).show();
                }
            });
