...
import java.util.List;
    ...
    public class AllAdapter extends RecyclerView.Adapter<com.example.freelancer.ski.AllAdapter.ViewHolder> {
        ...
        public AllAdapter(List<DesList> desList, Context context) {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder{
            ...
            public ViewHolder(@NonNull View itemView){
                super(itemView);
                des_item_rellayout = itemView.findViewById(R.id.ski_all_item_rellayout);
                des_item_imageView = itemView.findViewById(R.id.ski_all_item_imageView);
                des_item_name = itemView.findViewById(R.id.ski_all_item_name);
                des_item_created_at = itemView.findViewById(R.id.ski_all_item_created_at);
                des_item_updated_at = itemView.findViewById(R.id.ski_all_item_updated_at);
            }
        }

        @NonNull
        @Override
        public com.example.freelancer.ski.AllAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new com.example.freelancer.ski.AllAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.ski_all_list, parent, false));
        }

        @Override
        public void onBindViewHolder(@NonNull com.example.freelancer.ski.AllAdapter.ViewHolder holder, final int position) {
